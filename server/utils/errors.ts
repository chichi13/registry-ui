...
export class RegistryError extends AppError {
  constructor(
    message: string,
    statusCode: number = 500,
    code: string = ErrorCodes.REGISTRY_ERROR,
    details?: unknown
  ) {
...
export class ValidationError extends AppError {
  constructor(message: string, code: string = ErrorCodes.VALIDATION_ERROR, details?: unknown) {
...
export function mapRegistryError(
  ...
  switch (statusCode) {
    ...
    case 403:
      return new AuthError(
        'Access to registry resource forbidden',
        403,
    ...
    case 404:
      return new NotFoundError('Registry resource', responseBody?.name || 'unknown')
    ...
    case 502:
    case 503:
      return new ServiceUnavailableError('Docker Registry', {
        statusCode,
